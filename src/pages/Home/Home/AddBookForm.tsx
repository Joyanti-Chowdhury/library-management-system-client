...
const AddBookForm = () => {
  ...
  return (
    <div className="w-full px-4 sm:px-6 md:px-10 lg:px-0 max-w-2xl mx-auto py-8">
      <div className="bg-white dark:bg-muted/40 shadow-xl rounded-2xl border border-gray-200 dark:border-muted p-6 sm:p-8">
