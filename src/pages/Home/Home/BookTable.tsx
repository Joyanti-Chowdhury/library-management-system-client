...
const BookTable = ({ books }: IProps) => {
  ...
  <div className="w-full overflow-x-auto rounded-md border">
    <Table className="min-w-[900px]">
      <TableHeader>
        <TableRow>
          <TableHead className="text-center whitespace-nowrap">Title</TableHead>
          <TableHead className="text-center whitespace-nowrap">Author</TableHead>
          <TableHead className="text-center whitespace-nowrap">Genre</TableHead>
          <TableHead className="text-center whitespace-nowrap">ISBN</TableHead>
          <TableHead className="text-center whitespace-nowrap">Status</TableHead>
          <TableHead className="text-center whitespace-nowrap">Copies</TableHead>
      ...
      <TableBody>
        {books?.map((book) => (
          <TableRow key={book._id}>
            ...
            <TableCell className="text-center whitespace-nowrap">{book.author}</TableCell>
